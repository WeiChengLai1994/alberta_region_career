...
const EmployerDashboard = () => {
  ...
  const dashboardData = {
    ...
    postedJobsList: [
      ...
      {
        title: "Emergency Management Adviser",
        type: "Part-time",
        location: "Okotoks",
      },
      {
    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <div className="bg-gray-200 p-6 flex flex-col space-y-10 w-64">
          <h1 className="text-2xl font-bold text-custom-green-dark">
            Employer Dashboard
          </h1>
          <Link
          ...
          <div className="bg-white rounded-lg shadow-2xl p-4 mb-8 border border-gray-200">
            ...
            <div className="flex flex-col justify-center items-center h-150">
              <div className="flex flex-col justify-center items-center h-50 ">
                <Image
                  src="/image/employerDashboard_dataExample1.png"
                  alt="Applications Graph"
                  width={800}
                  height={400}
                />
              </div>
